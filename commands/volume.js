...
module.exports = {
	...
	run: async (bot, message, args, shared) => {
        ...
        if ( !args || !isNaN(args) || args.includes(".") || args.includes(",") || args.includes(" ") ) return await message.channel.send(`The current volume is \`${serverQueue.volume}\`. To change the volume, please provide a valid integer between \`0\` and \`10\`.`)

...
bot.on('message', async message => {
  ...
  if (message.guild.id === config.serverID && message.author.bot && message.channel.id !== "595151500603555871" && message.channel.id !== "585812719043870780") return message.delete();
